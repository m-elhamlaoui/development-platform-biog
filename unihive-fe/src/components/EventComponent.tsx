...
//       try {
//         if (!isMyTokenExpired) {
//           const response = await StudentService.getEvents(token);
...
//       (filterCity === "Choose" ||
//         event.eventLocation.toLowerCase().includes(filterCity.toLowerCase())) &&
//       (filterSchool === "Choose" ||
//         event.club.clubName.toLowerCase().includes(filterSchool.toLowerCase())) &&
...
//       (Object.keys(filterCategory).every((key) => !filterCategory[key]) ||
//         filterCategory[event.eventCategory])
//     );
//   });
...
//                 <Form.Select aria-label="Default select example" value={filterCity} onChange={handleCityChange}>
...
//                 <Form.Select aria-label="Default select example" value={filterSchool} onChange={handleSchoolChange}>
//                   <option>Choose</option>
...
//                   <Card.Subtitle>{`From ${formatDate(event.startTime)} to ${formatDate(
//                     event.endTime
//                   )}`}</Card.Subtitle>
